...
def pixel2cam(pixel_coords, intrinsics, is_homogeneous=True):
  ...
  """
  B, _, H, W = pixel_coords.get_shape().as_list()
...
def compute_rigid_flow(road, pose, intrinsics, reverse_pose=False):
  ...
  """
  batch, height, width = road.get_shape().as_list()
  ...
  cam_coords = pixel2cam(pixel_coords, intrinsics)
